...
open import Category.HigherCat using (𝕀; equiv-inj)
open import Category.Pullbacks using (_×c_; π₁; π₂; ⟨_,_⟩; pair-β₁; pair-β₂;
                            equiv-inv-rinv; equiv-inv-linv)
open import Category.Product using (product-map; injl-product-map; injr-product-map;
...
open import Interval.Interval using (invertible-to-equiv; equiv-comp)
