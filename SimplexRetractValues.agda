...
module SimplexRetractValues where
...
open import LastEdge using (ord-top; bwd-top-const; last-edge; dom-last-edge;
  edge-cod; c20-inv-top)
open import FaceTop using (top; c20-top)
open import FaceMap using (face)
open import Product using (injl; injr)
open import OrdComb using (sn2-pr1; sn2-snd; restrict; ord-suc-top; sn2-pr1-suc;
  sn2-snd-top; sn2-snd-face;
  deface; top-ind; sval; thr-pred; thr-mono; thr-ord)
open import ExpEval using (exp-eval)
open import Posetal using (posetal-eq-objects; Delta-posetal)
open import SimplexRetract
