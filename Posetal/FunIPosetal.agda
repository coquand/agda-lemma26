...
module Posetal.FunIPosetal where
...
open import Interval.Interval using (Δ; ob-to-𝟚; 𝕀-char-comparison;
...
open import Interval.IntervalPosetal using (𝕀-thin; 𝕀-hom-to-order; 𝕀-order-to-hom)
open import Interval.FaceOrdCompat using (ev-point)
open import Posetal.PosetalCore
