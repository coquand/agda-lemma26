...
module SegalGeom where

open import Spartan
open import CatAxioms
open import HigherCat using (𝕀; 𝟚; Mor; equiv-inj)
open import Constructions using (𝕀₀; 𝕀₁; dom; cod; Hom; equiv-inv; cod-nat; dom-nat)
open import Pullbacks using (equiv-inv-rinv; equiv-inv-linv)
open import Exponentials using (Fun)
open import Interval using (Δ; invertible-to-equiv; equiv-comp)
open import Segal using (ComposablePair; segal-comparison; segal-equiv;
  segal-is-equiv; d₀₁; d₁₂; segal-comm)
open import FaceMap using (face)
open import FaceTop using (top)
open import LastEdge using (last-edge)
open import UnitIso using (eval-pt; eval-pt-isIso)
open import PushoutBase using (eval-pt-top1; eval-pt-dom-last)
open import PushoutProof using (eval-pt-inv; eval-pt-rinv; eval-pt-linv)
open import SigmaEquiv using (Σ-change-of-base; Σ-fiberwise-equiv;
  post-comp-path-equiv; pre-comp-path-equiv)
open import SquareGeom using (Sq; v0-Δ1; lastedge; square-commutes)
open import Square
open import Coherence using (ap-∙; ap-⁻¹; ∙-cong; cancel-left)
open import HLevels using (ob-Δ-is-set)
open import GroupoidSolver using (Expr; ι; ε; _⊕_; inv; eval; solveG; cancL; cancR)
